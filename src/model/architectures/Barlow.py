...
class BarlowTwins(nn.Module):
    ...
    # ====================== for regularization ===========================
    def get_conv_layer_eigvals(self, max_layer: int = 4) -> torch.Tensor:
        """wrapper for getting the convolution layer eigenvalues"""
        return self.backbone.get_conv_layer_eigvals(max_layer=max_layer)
